...
void version()
{
	...
	serial_println("Completion Date: Wednesday, March 18, 2015");
	serial_println("");
}
...
void help()
{
	while(1) {
		...
		if (!strcmpigncase(command, "commands")) {
		  ...
		  serial_println("Loads all r3 processes into memory in a ready blocked state. Use 'yield' command to begin their execution.");
		  break;
		}
