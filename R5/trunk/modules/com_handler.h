...
/*
  Procedure..: heapInitialize
  Description..: Initializes the memory heap to the given size
*/
void heapInitialize(int size);

/*
  Procedure..: allocateMem
  Description..: Prompts the user for a number of bytes and allocates a block of memory to that size
*/
void* allocateMem();

/*
  Procedure..: freeMem
  Description..: Prompts the user for an address of a memory block and frees it
*/
void freeMem();

/*
  Procedure..: printAlloc
...
/*
  Procedure..: isEmpty
  Description..: Prints whether the heap is empty or not
*/
void isEmpty();
